...
import com.audit.agriin.AgriInApplication;
...
public class TenantsConfiguration {
    ...
    @Bean
    MultiTenantConnectionProvider<String> multiTenantConnectionProvider(DataSource dataSource) {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource,
        ...
        entityManagerFactoryBean.setPackagesToScan(AgriInApplication.class.getPackageName());
    ...
    public static final class TenantSchemaSelector implements CurrentTenantIdentifierResolver<String> {
    ...
    public static final class TenantConnectionProvider implements MultiTenantConnectionProvider<String> {
