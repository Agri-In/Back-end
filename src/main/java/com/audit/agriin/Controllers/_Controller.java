...
public abstract class _Controller<ID, RequestType extends _Request, ResponseType extends _Response, ServiceType extends _Service<RequestType, ResponseType, ID>> {
    ...
    public ResponseEntity<ResponseType> create(
        ...
        if (bindingResult.hasErrors()){
            log.error("Error: request params are not valid", bindingResult);
    ...
    public ResponseEntity<ResponseType> update(
        ...
        if (bindingResult.hasErrors()){
            log.error("Error while updating entity", bindingResult);
            handleValidationError(bindingResult);
        }
    ...
    /**
     * Handles validation errors by throwing a {@link com.audit.agriin.Exceptions.ResourceNotCreatedException}.
     *
     * @param bindingResult The result of the validation.
     */
