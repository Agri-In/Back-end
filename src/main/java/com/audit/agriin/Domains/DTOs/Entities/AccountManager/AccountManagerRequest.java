...
public record AccountManagerRequest(
        ...
        String addressRegion, String addressDistrict, String addressCity, String addressStreet, Integer addressBuilding,
        Integer addressPostalCode, Set<Long> userGroupIds, boolean enabled, int failedLoginAttempts,
        boolean loginDisabled, boolean accountNonLocked, UUID qualityManagerId,
        UUID managedCompanyId) implements _Request {
}